...
# `schemas/open-test-intent.v1.json` at the immutable `schema-v1` tag (git blob
# 189f2efe5a95a23f593c84b794dc2b0cb6ca2bc1) — the same bytes the schema's own `$id` resolves to.
...
module OpenTestIntent
  ...
  SCHEMA_BLOB_SHA = "189f2efe5a95a23f593c84b794dc2b0cb6ca2bc1"
