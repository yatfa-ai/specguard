...
class RepositoriesController < ApplicationController
  ...
  helper_method :github_listing, :github_listing_error, :github_authorization_needed?
  ...
  def github_listing
    ...
    @github_listing =
      begin
        ...
        @github_listing_error = e.is_a?(GithubApi::Unauthorized) ? :token_rejected : :unavailable
        nil
      end
  end
  ...
  # the user has ever granted repository access, and again after a token stops working.
  def github_authorization_needed?
    !current_user.github_repository_access? ||
      github_listing_error == :token_rejected ||
