...
#
# The sibling of `RequestedBranchParam`, and deliberately its own module rather than a widening of
# it: the two parameters mean different things, are read by different surfaces, and one guard
# answering both would make "which shapes does the branch parameter tolerate" and "which shapes
# does the spec-file parameter tolerate" a single question nobody asked. What they share is the
