...
# itself, restated here because it does not weaken with repetition. The parameters mean different
# things, are read by different surfaces and narrow different grains, and one guard answering
# several of them would make "which shapes does each tolerate" a single question nobody asked. What
# they share is the hazard, and the guard for it is the same two lines in the same order.
#
