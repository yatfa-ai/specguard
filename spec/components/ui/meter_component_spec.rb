...
#   * that same panel's `UI::MeterComponent.new(value: annotated_specs, max: total_specs, label:
#     "Annotated")` call site -> this component — `((value / max) * 100).clamp(0.0, 100.0).round(1)`,
